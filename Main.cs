...
namespace DataAnalysisTool
{
    ...
    (e.KeyChar != '.'))
        ...
        private void backgroundWorker25_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
        ...
        private void backgroundWorker26_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
        ...
        private void backgroundWorker27_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker28_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker28_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker29_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker29_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker30_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker30_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker31_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker31_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker32_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker32_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker33_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker33_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker34_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker34_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker35_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker35_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker36_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker36_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker37_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker37_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker38_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker38_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker39_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker39_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker40_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker40_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {

        }

        private void backgroundWorker41_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker42_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker43_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker44_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker45_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker46_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker47_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker48_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker49_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }

        private void backgroundWorker50_DoWork(object sender, DoWorkEventArgs e)
        {
            Loading loading = new Loading();
            loading.ShowDialog();
        }
